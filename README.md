...
La diferencia radica en la constancia del tiempo de los datos<br>
<br>**Latencia:**  Es el tiempo total que tarda un paquete de datos en viajar desde el origen hasta el destino. Se mide generalmente en milisegundos (ms). Es el "retraso" puro.<br><br>
